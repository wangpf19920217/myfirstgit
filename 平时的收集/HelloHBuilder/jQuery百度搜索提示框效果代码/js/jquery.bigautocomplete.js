(function($){
	var bigAutocomplete = new function(){
		...
		this.init = function(){
			$("body").append("<div id='bigAutocompleteContent' class='bigautocomplete-layout'></div>");//给body添加一个div 
		...
		this.autocomplete = function(param){
			...
			$this.keydown(function(event) {
				...
				case 40://向下键
					...
					if($bigAutocompleteContent.css("display") == "none")return;  // 如果提示是隐藏的则返回  否则继续
					
					var $nextSiblingTr = $bigAutocompleteContent.find(".ct");  // ct 为当前项  找到当前项   滑过时addclass
